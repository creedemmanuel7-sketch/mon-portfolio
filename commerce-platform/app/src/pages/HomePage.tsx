    ...
    <>
      <section className="relative min-h-[70vh] overflow-hidden text-white">
        ...
        <div className="relative mx-auto flex min-h-[70vh] max-w-6xl flex-col justify-end px-4 pb-14 pt-24">
          <p className="mb-3 text-xs font-bold uppercase tracking-[0.2em] text-copper">40 pièces · Nouvelle sélection</p>
          <h1 className="font-display max-w-[12ch] text-4xl font-bold leading-tight sm:text-6xl">
            Objets justes, pour le quotidien.
          </h1>
          <p className="mt-4 max-w-md text-white/90">
            Boutique lifestyle contemporaine — tech douce, maison et accessoires.
          </p>
      ...
      <section className="mx-auto max-w-6xl px-4 py-12">
        ...
        <p className="mb-6 text-muted">Une sélection parmi les 40 pièces Atelier Sika.</p>
